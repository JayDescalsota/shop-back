...
INSERT INTO lookup.parts (name, category) VALUES
    ('Oil Filter','Filters'),
    ...
    ('Brake Rotors - Front','Brakes'),
    ('Brake Rotors - Rear','Brakes'),
    ...
    ('Wheel Bearing','Wheels'),
    ('CV Axle','Drivetrain'),
    ('Drive Shaft','Drivetrain'),
    ('Differential','Drivetrain'),
    ('Transmission Filter','Transmission'),
    ('Transmission Pan Gasket','Transmission'),
    ('Engine Oil 5W-30','Fluids'),
    ('Engine Oil 0W-20','Fluids'),
    ('Coolant 50/50','Fluids'),
    ('Transmission Fluid','Fluids'),
    ('Power Steering Fluid','Fluids'),
    ('Brake Fluid DOT 3','Fluids'),
    ('Windshield Washer Fluid','Fluids'),
    ('Headlight Bulb - LED','Lighting'),
    ('Headlight Assembly','Lighting'),
    ('Taillight Assembly','Lighting'),
    ('Fog Light','Lighting'),
    ('Turn Signal Relay','Lighting'),
    ('Wiper Blade - Driver','Wipers'),
    ('Wiper Blade - Passenger','Wipers'),
    ('Wiper Blade - Rear','Wipers'),
    ('Horn','Electrical'),
    ('Fuse Box','Electrical'),
    ('Oxygen Sensor','Sensors'),
    ('Mass Air Flow Sensor','Sensors'),
    ('Crankshaft Position Sensor','Sensors'),
    ('Camshaft Position Sensor','Sensors'),
    ('Knock Sensor','Sensors'),
    ('Throttle Body','Engine'),
    ('EGR Valve','Engine'),
    ('PCV Valve','Engine'),
    ('Radiator Cap','Cooling'),
    ('Radiator Hose - Upper','Cooling'),
    ('Radiator Hose - Lower','Cooling'),
    ('Heater Hose','Cooling'),
    ('Thermostat Housing','Cooling'),
    ('Valve Cover Gasket','Engine'),
    ('Oil Pan Gasket','Engine'),
    ('Intake Manifold Gasket','Engine'),
    ('Exhaust Manifold Gasket','Engine'),
    ('Catalytic Converter','Exhaust'),
    ('Muffler','Exhaust'),
    ('Exhaust Pipe','Exhaust'),
    ('Clutch Kit','Transmission'),
    ('Clutch Slave Cylinder','Transmission'),
    ('Clutch Master Cylinder','Transmission')
ON CONFLICT (name) DO UPDATE SET category=EXCLUDED.category;

INSERT INTO lookup.storage_locations (name, code) VALUES
    ('Shelf A1','A1'),
    ('Shelf A2','A2'),
    ('Shelf A3','A3'),
    ('Shelf B1','B1'),
